...
<div class="topnav">
	...
	<ul id="topnavbar">
		...
		<li class="topmenu"><a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('edit.aspx?id=0',680,430,true)" class="top_link"><span>添加公告</span></a></li>
	</ul>
	<script>
	topnavbarStuHover();
    </script>
...
<tbody>
	...
	<tr>
		...
		<td align="center" class="oper">
			<a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('edit.aspx?id={$T.record.id}',680,430,true)">修改</a>
		</td>
	</tr>
	{#/for}
</tbody>

...
<div class="topnav">
	...
	<ul id="topnavbar">
		...
		<li class="topmenu"><a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('edit.aspx?id=0',620,400,true)" class="top_link"><span>添加调查</span></a></li>
	</ul>
	<script>
	topnavbarStuHover();
    </script>
...
<tbody>
	...
	<tr>
		...
		<td align="left">{$T.record.votetotal}</td>
		<td align="center">
			{#if $T.record.type == "1"}
			多选
			{#else}
		...
		<td align="center" class="oper">
			<a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('edit.aspx?id={$T.record.id}',620,400,true)">修改</a>
		</td>
	</tr>
	{#/for}
</tbody>

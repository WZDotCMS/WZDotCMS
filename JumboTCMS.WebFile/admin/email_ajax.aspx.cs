...
{
    public partial class _email_ajax : JumboTCMS.UI.AdminCenter
    {
        ...
        private void ajaxGetList()
        {
            ...
            sqlStr = JumboTCMS.Utils.SqlHelp.GetSql("A.id as id,A.NickName as NickName,A.EmailAddress as EmailAddress,B.GroupName as GroupName,A.state as state", "jcms_normal_email", "jcms_normal_emailgroup", "Id", PSize, page, "desc", joinStr, whereStr1, whereStr2);
            doh.Reset();
            doh.SqlCmd = sqlStr;
        ...
        private void GetEmailInfo()
        {
            ...
            doh.ConditionExpress = whereStr2;
            countNum = doh.Count("jcms_normal_email");
            sqlStr = JumboTCMS.Utils.SqlHelp.GetSql("A.*,B.GroupName", "jcms_normal_email", "jcms_normal_emailgroup", "Id", PSize, page, "desc", joinStr, whereStr1, whereStr2);
            doh.Reset();
            doh.SqlCmd = sqlStr;
            DataTable dt = doh.GetDataTable();

...
function go2Search(){
	...
	top.IframeOper.location.href=site.Dir + "modules/" + q('ctype') + "_admin_list.aspx?ccid=" + q('ccid') + "&ctype=" + q('ctype') + "&cid=" + _cid + "&k=" + encodeURIComponent(_k) + "&s=" + _s + "&f=" + _f + "&d=" + _d + "&isimg=" + _isimg + "&istop=" + _istop + "&isfocus=" + _isfocus;

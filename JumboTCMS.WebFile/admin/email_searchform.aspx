<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="email_searchform.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._email_searchform" %>
...
function go2Search(){
	...
	top.IframeOper.location.href="email_list.aspx?gid="+_gid+"&keys="+encodeURIComponent(_keys);

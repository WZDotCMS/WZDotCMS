...
{
    public partial class _photo_user_ajax : JumboTCMS.UI.UserCenter
    {
        ...
        private void ajaxCheckName()
        {
            if (id == "0")
            {
                ...
                if (doh.Exist("jcms_module_photo"))
        ...
        private void ajaxGetList()
        {
            ...
            this._response = GetContentList("photo", cid, _f, _k, _d, _s, "2", PSize, page);
        }
        private void ajaxDel()
        {
            User_Load("", "json");
            string lId = f("id");
            this._response = checkDel(lId, "photo");
        }
    }
}
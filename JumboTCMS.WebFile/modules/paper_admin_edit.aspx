<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paper_admin_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Modules._paper_admin_edit" %>
...
$(document).ready(function(){
	...
	$("#txtTitle").formValidator({tipid:"tipTitle",onshow:"请输入标题，单引号之类的将自动过滤",onfocus:"至少输入6个字符"}).InputValidator({min:6,onerror:"至少输入6个字符,请确认"})
		...
		type : "get",
		data:		"id=<%=id%>" + ccid,
		url:		"paper_admin_ajax.aspx?oper=checkname&time="+(new Date().getTime()),
		datatype : "json",
		success : function(d){	
			if(d.result == "1")
				return true;

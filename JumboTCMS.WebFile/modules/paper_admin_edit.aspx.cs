...
{
    public partial class _paper_admin_edit : JumboTCMS.UI.AdminCenter
    {
        ...
        protected void save_ok(object sender, EventArgs e)
        {
            ...
            bool _SaveSWF = JumboTCMS.Utils.swftoolsHelp.PDF2SWF(PdfFile, SwfFile);
            ...
            if (_SaveSWF)
                ...
                FinalMessage("SWF生成失败", "../admin/close.htm", 0);
        }

...
{
    public partial class _Soft_admin_edit : JumboTCMS.UI.AdminCenter
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            wh.AddBind(txtDownUrl, "DownUrl", true);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //格式化地址
            this.txtDownUrl.Text = this.txtDownUrl.Text.Replace("\'", "").Replace("\"", "");
            //新加关键词

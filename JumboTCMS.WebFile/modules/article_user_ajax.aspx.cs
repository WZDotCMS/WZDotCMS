...
{
    public partial class _article_user_ajax : JumboTCMS.UI.UserCenter
    {
        ...
        private void ajaxGetList()
        {
            ...
            this._response = GetContentList("article", cid, _f, _k, _d, _s, "2", PSize, page);
        }
        private void ajaxDel()
        {
            User_Load("", "json");
            string lId = f("id");
            this._response = checkDel(lId, "article");
        }
    }
}
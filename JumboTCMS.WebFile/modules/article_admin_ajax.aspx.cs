...
{
    public partial class _article_admin_ajax : JumboTCMS.UI.AdminCenter
    {
        ...
        private void ajaxCopy()
        {
            string sId = f("id");
            doh.Reset();
            doh.SqlCmd = "SELECT [ChannelId],[ClassId],[Title],[TColor],[Summary],[Editor],[Author],[Tags],[IsPass],[IsImg],[Img],[IsTop],[UserId],[ReadGroup],[SourceFrom],[Content] FROM [jcms_module_article] WHERE [Id]=" + sId;

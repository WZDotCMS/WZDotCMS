...
{
    public partial class _video_admin_edit : JumboTCMS.UI.AdminCenter
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string[] VideoUrlArr = txtVideoUrl.Text.Split(new string[] { "\r" }, StringSplitOptions.RemoveEmptyEntries);
            ...
            for (int i = 0; i < VideoUrlArr.Length; i++)
            {
                ...
                if (!JumboTCMS.Utils.DirFile.FileExists(thumbnailImage))
                    JumboTCMS.Utils.ffmpegHelp.CatchImg(ThisVideoUrl[ThisVideoUrl.Length - 1], iWidth + "x" + iHeight, "15"); ;

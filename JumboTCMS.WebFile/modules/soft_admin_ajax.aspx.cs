...
{
    public partial class _Soft_admin_ajax : JumboTCMS.UI.AdminCenter
    {
        ...
        private void ajaxCopy()
        {
            string sId = f("id");
            doh.Reset();
            doh.SqlCmd = "SELECT [ChannelId],[ClassId],[Title],[TColor],[Summary],[Content],[Editor],[Author],[Tags],[IsPass],[IsImg],[Img],[IsTop],[UserId],[ReadGroup],[SourceFrom],[Version],[OperatingSystem],[UnZipPass],[DemoUrl],[RegUrl],[SSize],[Points],[DownUrl] FROM [jcms_module_soft] WHERE [Id]=" + sId;

...
$(document).ready(function(){
	...
	$("#txtOldPass").formValidator({tipid:"tipOldPass",onshow:"请输入6-14位密码",onfocus:"请输入6-14位密码"}).InputValidator({min:6,max:14,onerror:"密码6-14位"});
	$("#txtNewPass1").formValidator({tipid:"tipNewPass1",onshow:"请输入6-14位密码",onfocus:"请输入6-14位密码"}).InputValidator({min:6,max:14,onerror:"密码6-14位"});
	$("#txtNewPass2").formValidator({tipid:"tipNewPass2",onshow:"两次密码必须一致",onfocus:"两次密码必须一致"}).InputValidator({min:6,max:14,onerror:"密码6-14位,请确认"}).CompareValidator({desID:"txtNewPass1",operateor:"=",onerror:"两次密码不一致"});
});
//Form验证

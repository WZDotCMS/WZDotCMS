        ...
        public string ChkAdminLogin(string _adminname, string _adminpass, int iExpires)
        {
            ...
            using (DbOperHandler _doh = new Common().Doh())
            {
                ...
                if (_adminid != "0" && _adminid != "")
                {
                    ...
                    {
                        if (_Admin.AdminPass.ToLower() != JumboTCMS.Utils.MD5.Lower16(_adminpass))
                        {
                            //_doh.Dispose();
                            return "密码错误";
                        }
                    ...
                    {
                        if (_Admin.AdminPass.ToLower() != JumboTCMS.Utils.MD5.Lower32(_adminpass))
                        {
                            //_doh.Dispose();
                            return "密码错误";
                        }
                    ...
                    myCol.Add("password", JumboTCMS.Utils.MD5.Lower32(_adminpass));
                    ...
                    if (_Admin.AdminPass.Length == 16)//老密码
                        _doh.AddFieldItem("AdminPass", JumboTCMS.Utils.MD5.Lower32(_adminpass));
